...
window.Music = window.Music || (function () {
  ...
  var LEVEL_KEY = { 'boss2':'boss2', 'boss':'boss', 'durag':'durag',
                    ...
                    'roller':'chase',
                    // v34.1.0 — Skyline Sidekicks Shook II plays the
                    // original's track (the second sky sounds like the
                    // first; no new file).
                    'sky2':'level4',
                    // v35.0.0 — Durag Ceremony 2 plays the first
                    // ceremony's track (no new file).
                    'durag2':'durag' };
